...
Now how do we write a server in Python that can recognize and respond to
these methods? Here’s the code for a minimal server. It doesn’t
actually serve anything, but it does respond to all four request types
(GET, PUT, POST and DELETE) and displays the type of the request it has
received.
